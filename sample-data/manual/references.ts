export const substitutions = {
    "arrow": '➤',
    "atlas-ref": 'Query Documents with MongoDB Atlas',
...
export const refs = {
    ...
    'document-query-filter': { title: 'query filter document', url: 'document-query-filter' },
    ...
    'sharding-background': { title: 'shards', url: 'sharding-background' },
