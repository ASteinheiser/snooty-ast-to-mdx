...
import ChangestreamRcMajority4.2 from './includes/extracts/changestream-rc-majority-4.2.mdx';
...
import 4.2ChangesChangeStreamModificationError from './includes/extracts/4.2-changes-change-stream-modification-error.mdx';
...
<Tip>
  ...
  <4.2ChangesChangeStreamModificationError />
