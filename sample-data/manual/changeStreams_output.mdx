...
<Include source="/includes/change-streams-optimization.mdx" />
...
* **Read Concern "majority" Enablement.**
  ...
  <Include source="/includes/extracts/changestream-rc-majority-4.2.mdx" />

### Stable API Support

<Include source="/includes/stable-api/change-stream-support.mdx" />
...
<Include source="/includes/extracts/changestream-cursor-open.mdx" />
...
<Tabs tabset="drivers">
  <Tab tabid="c">
    ...
    <Include source="/includes/fact-change-streams-modify-output.mdx" />
...
<Tip>
  ...
  <Include source="/includes/extracts/4.2-changes-change-stream-modification-error.mdx" />
...
<Important>
  ...
  * <Include source="/includes/extracts/changestream-invalid-events.mdx" />
</Important>
...
<Tip>
  <Include source="/includes/note-decode-resume-tokens.mdx" />
</Tip>
...
<Include source="/includes/change-streams-and-orphans.mdx" />

<span id="std-label-change-stream-pre-post-images" />

## Change Streams with Document Pre- and Post-Images

<Include source="/includes/change-stream-pre-and-post-images-introduction.mdx" />

<Include source="/includes/change-stream-pre-and-post-images-additional-information.mdx" />
