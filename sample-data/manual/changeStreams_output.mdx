...
<Include source="/includes/change-streams-optimization.rst">
...
* **Read Concern "majority" Enablement.**
  ...
  <Include source="/includes/extracts/changestream-rc-majority-4.2.rst">
    <Extract>
...
<Include source="/includes/stable-api/change-stream-support.rst">
...
<Include source="/includes/extracts/changestream-cursor-open.rst">
  <Extract>
    ...
    * <Include source="/includes/extracts/changestream-remove-shard.rst">
        <Extract>
...
<Tabs tabset="drivers">
  <Tab tabid="c">
    ...
    <Include source="/includes/fact-change-streams-modify-output.rst">
      ...
      <Include source="/includes/extracts/changestream-available-pipeline-stages.rst">
        <Extract>
...
<Tip>
  ...
  <Include source="/includes/extracts/4.2-changes-change-stream-modification-error.rst">
    <Extract>
...
<Important>
  ...
  * <Include source="/includes/extracts/changestream-invalid-events.rst">
      <Extract>
...
<Tip>
  <Include source="/includes/note-decode-resume-tokens.rst">
    MongoDB provides a <Ref url="https://www.mongodb.com/docs/mongodb-shell/snippets/#std-label-snip-overview">"snippet"</Ref>, an
    extension to <Ref url="https://www.mongodb.com/docs/mongodb-shell/#mongodb-binary-bin.mongosh">`mongosh`</Ref>, that decodes hex-encoded
    resume tokens.

    You can install and run the [resumetoken](https://github.com/mongodb-labs/mongosh-snippets/tree/main/snippets/resumetoken)
    snippet from <Ref url="https://www.mongodb.com/docs/mongodb-shell/#mongodb-binary-bin.mongosh">`mongosh`</Ref>:
    ...
    from the command line (without using <Ref url="https://www.mongodb.com/docs/mongodb-shell/#mongodb-binary-bin.mongosh">`mongosh`</Ref>) if `npm`
    ...
    * <Ref url="https://www.mongodb.com/docs/mongodb-shell/snippets/working-with-snippets/#std-label-snip-using-snippets">using snippets</Ref> in <Ref url="https://www.mongodb.com/docs/mongodb-shell/#mongodb-binary-bin.mongosh">`mongosh`</Ref>.
  </Include>
</Tip>
...
<Include source="/includes/change-streams-and-orphans.rst">
...
<Include source="/includes/change-stream-pre-and-post-images-introduction.rst">
...
<Include source="/includes/change-stream-pre-and-post-images-additional-information.rst">
  ...
  * Pre-images are written to the <Ref url="config.system.preimages">`config.system.preimages`</Ref>
  ...
  <Important>
    ...
    <Include source="/includes/downgrade-for-pre-and-post-images.rst">
